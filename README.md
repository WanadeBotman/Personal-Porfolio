# Wanade Botman | Front-End Developer Portfolio 🚀
---
<img width="1917" height="902" alt="Portfolio" src="https://github.com/user-attachments/assets/0d2307b6-f2d2-469b-bf7e-a865b62a6c24" />
...
* **Dynamic Theme Switching**: Seamless toggle between **Light and Dark modes** with persistent state using `localStorage`.
* **Modern UI/UX**: Includes a scroll progress bar, custom typing animations for professional roles, and smooth section transitions using **Intersection Observer API**.
...
* **GitHub**: [@WanadeBotman](https://github.com/WanadeBotman)
* **LinkedIn**: [Wanade Botman](https://linkedin.com/in/https://www.linkedin.com/in/wanade-botman/)
* **Instagram**: [@sharkcxde_](https://www.google.com/search?q=https://instagram.com/sharkcxde_)
